...
//   }
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    // final filteredEstablishmentsProvider = StateProvider<List<dynamic>>((ref) {
    //   final filters = ref.watch(filterProvider.notifier).state;
    //   final establishments = ref.watch(establishmentProvider);
    //   var filtersValue = "";

    //   if (filters == 1) {
    //     filtersValue = "Restaurant";
    //   } else if (filters == 2) {
    //     filtersValue = "Hotels";
    //   } else if (filters == 3) {
    //     filtersValue = "Beach";
    ...
    //         .where((establishment) => establishment.category == filtersValue)
    //         .toList();
    //   } else {
    //     if (establishments is AsyncData<List<Establishment>>) {
    //       // Access the actual data and apply the where method
    //       return establishments.value.toList();
    //     } else {
    //       // Return an empty list or handle other states as needed
    //       return [];
    //     }
    //   }
    // });
